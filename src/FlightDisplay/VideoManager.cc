...
VideoManager::setToolbox(QGCToolbox *toolbox)
{
   ...
   connect(_videoSettings->audioUdpEnabled(), &Fact::rawValueChanged, this, &VideoManager::_audioUdpEnabledChanged);
...
//-----------------------------------------------------------------------------
void
VideoManager::_audioUdpEnabledChanged()
{
    _updateAudioPipeline();
}
